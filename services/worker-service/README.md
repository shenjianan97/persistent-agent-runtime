...
All SQL queries are taken verbatim from `docs/design/PHASE1_DURABLE_EXECUTION.md` Section 6.1. All reaper operations use `UPDATE ... RETURNING` to avoid TOCTOU races between multiple reaper instances.
