                                    ...
                                    <div className="rounded-lg bg-muted/10 border border-white/5 p-4 space-y-3">
                                        ...
                                        {isLoadingAgent ? (
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
                                                ...
                                                {(() => {
                                                    const autoManaged = new Set(['request_human_input', 'web_search', 'read_url', 'create_text_artifact', 'plan_write', 'sandbox_exec', 'sandbox_read_file', 'sandbox_write_file', 'export_sandbox_file']);
