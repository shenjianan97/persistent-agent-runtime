        ...
        <div className="flex flex-col shrink-0 z-10 w-full">
            ...
            <header className="h-16 flex items-center justify-between px-6 border-b border-border/40 bg-background/95 backdrop-blur">
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="font-display font-semibold text-lg tracking-tight">PERSISTENT_AGENT_RUNTIME</h1>
                </div>
                ...
                <div className="flex items-center gap-6 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className={cn("font-bold", (!health || health.active_workers === 0) ? "text-destructive" : "")}>
