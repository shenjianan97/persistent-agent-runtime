...
1. `docs/design/phase-2/track-1-agent-control-plane.md` — canonical design contract (Data Model section)
...
- Treat `docs/design/phase-2/track-1-agent-control-plane.md` as the canonical schema contract.
