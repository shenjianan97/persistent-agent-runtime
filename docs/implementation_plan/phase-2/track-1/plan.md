...
**Canonical design contract:** `docs/design/phase-2/track-1-agent-control-plane.md`
...
- Use `docs/design/phase-2/track-1-agent-control-plane.md` as the canonical design contract
