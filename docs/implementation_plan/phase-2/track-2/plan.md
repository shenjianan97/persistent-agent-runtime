...
**Canonical design contract:** `docs/design/phase-2/PHASE2_MULTI_AGENT.md` (Sections 5, 7, 8)
...
- Use `docs/design/phase-2/PHASE2_MULTI_AGENT.md` Sections 5, 7, 8 as the canonical design contract
