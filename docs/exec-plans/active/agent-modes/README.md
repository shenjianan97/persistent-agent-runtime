...
| [Planning Primitive](planning-primitive/plan.md) | ReAct agent to-do-list scratchpad: `plan_write` tool + post-compaction injection + read-only `GET /v1/tasks/{id}/plan` + Console checklist | 5 tasks; small, low-risk, no open blockers | Planned — not started |
