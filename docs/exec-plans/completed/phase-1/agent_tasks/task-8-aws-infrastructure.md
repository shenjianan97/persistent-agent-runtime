...
- Treat `docs/product-specs/index.md` and `docs/design-docs/phase-1/design.md` as the canonical infrastructure direction. This task should not reopen Phase 1 architecture choices already made.
