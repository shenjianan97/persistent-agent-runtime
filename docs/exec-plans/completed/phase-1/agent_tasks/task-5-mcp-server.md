...
- Treat `docs/design-docs/phase-1/design.md` as the canonical Phase 1 tool contract. Phase 1 tools are strictly read-only and idempotent by design.
...
- **File paths (if known):** `services/worker-service/tools/`
