...
- Treat `docs/design-docs/phase-1/design.md` as the canonical checkpointer behavior contract. The important safety rule is lease-aware checkpoint writes, not speculative library redesign.
