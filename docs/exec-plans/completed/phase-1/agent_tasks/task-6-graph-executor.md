...
- Treat `docs/design-docs/phase-1/design.md` as the canonical execution contract. Do not redefine retry policy, dead-letter reasons, or resume semantics here.
