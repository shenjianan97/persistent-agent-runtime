...
1. `docs/design-docs/phase-2/design.md` — canonical design contract (Sections 5, 7, 8)
...
- Treat `docs/design-docs/phase-2/design.md` Sections 5, 7, 8 as the canonical schema contract.
