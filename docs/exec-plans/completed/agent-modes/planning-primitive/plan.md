...
>
> **One of two tracks under [Agent Modes](../README.md).** Sibling track: [Supervisor Topology](../supervisor-topology/plan.md) (independent; shares only `RuntimeState`, the worker tool registry, and the Console Activity pane — see *Cross-track coordination* in §A3).
