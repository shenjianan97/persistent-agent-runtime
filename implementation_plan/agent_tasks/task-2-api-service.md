...
- Treat `design/PHASE1_DURABLE_EXECUTION.md` as the canonical API contract. Do not add endpoints, alternate state transitions, or response fields unless the design doc is updated.
...
- **File paths (if known):** `src/api-service/src/main/java/` and `src/api-service/src/main/resources/`
