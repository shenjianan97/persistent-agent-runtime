...
- Treat `design/PHASE1_DURABLE_EXECUTION.md` as the canonical execution contract. Do not redefine retry policy, dead-letter reasons, or resume semantics here.
...
- **File paths (if known):** `src/worker-service/executor/`
