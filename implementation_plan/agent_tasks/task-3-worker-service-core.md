...
- Treat `design/PHASE1_DURABLE_EXECUTION.md` as the canonical worker lifecycle contract. Do not invent alternate claim, heartbeat, retry, or reaper semantics.
...
- **File paths (if known):** `src/worker-service/core/`
